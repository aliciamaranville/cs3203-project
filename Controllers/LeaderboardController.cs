...
using SofEngProject.Data;
using SofEngProject.Models;

namespace SofEngProject.Controllers
{
    public class LeaderboardController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Score")] Leaderboard leaderboard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Score")] Leaderboard leaderboard)
        {
        ...
        {
          return (_context.Leaderboard?.Any(e => e.ID == id)).GetValueOrDefault();
        }
    }
}
